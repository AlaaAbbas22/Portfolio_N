  ...
  return (
    <main className="relative -top-20">
      <div className="min-h-screen  pt-40">
        ...
        <div><button className='mx-auto animate-bounce mt-20 px-4 py-3 shadow-2xl rounded-full bg-slate-100 text-black' onClick={()=>{first.current?.scrollIntoView({ behavior: "smooth"})}}>&#8595;</button></div>
      </div>
      <div ref={first} className="min-h-screen">
        <div className=' font-mono  sm:text-xl text-sm mx-auto pt-40'>
         
        <p className='mx-auto text-justify sm:py-8 py-2 ring-2 rounded-xl bg-slate-100 leading-loose tracking-widest sm:px-10 px-3 md:w-2/3 text-black'>
